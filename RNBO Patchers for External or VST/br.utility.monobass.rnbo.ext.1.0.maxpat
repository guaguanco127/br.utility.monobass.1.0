...
,
		"classnamespace" : "box",
		"rect" : [ -289.0, -1025.0, 1163.0, 881.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 293.0, 149.0, 41.0, 48.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 							{
								...
								"index" : 4,
								"tag" : "in4",
								"comment" : "Cutoff Frequency (float) 0. - 10,000 120"
							}
, 							{
								"type" : "event",
								"index" : 5,
								"tag" : "in5",
								"comment" : "Bass Mix dB, (int) 0 = 0.0, 1 = -3.0, 2 = -6 dB 1"
							}
 ]
					}
,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 543.0, 191.0, 290.0, 37.0 ],
									"rnbo_classname" : "in",
...
,
										...
										"outputs" : [ 											{
												...
												"displayName" : "Bass Mix dB, (int) 0 = 0.0, 1 = -3.0, 2 = -6 dB 1",
												"docked" : 0
											}
 ],
										"helpname" : "in",
...
,
									"text" : "in 5 @comment \"Bass Mix dB, (int) 0 = 0.0, 1 = -3.0, 2 = -6 dB\" 1"
								}
...
,
									...
									"patching_rect" : [ 235.5, 412.0, 134.0, 23.0 ],
									"rnbo_classname" : "gen~",
									"rnbo_extra_attributes" : 									{
										"exposeparams" : 0
									}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 309.0, 114.0, 312.0, 23.0 ],
									"rnbo_classname" : "in",
									"rnbo_extra_attributes" : 									{
										"meta" : ""
									}
...
,
										...
										"outputs" : [ 											{
												...
												"displayName" : "Cutoff Frequency (float) 0. - 10,000 120",
												"docked" : 0
											}
 ],
										"helpname" : "in",
...
,
									"text" : "in 4 @comment \"Cutoff Frequency (float) 0. - 10,000\" 120",
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-8", 4 ],
									"midpoints" : [ 552.5, 397.5, 360.0, 397.5 ],
									"source" : [ "obj-10", 0 ]
								}
